...
export interface UseMouseExOptions extends ConfigurableWindow, ConfigurableEventFilter {
    /**
...
/**
 * Reactive mouse position including relative pointer coordinates.
 *
 * @param options
 */
export function useMouseEx(options: UseMouseExOptions = {}) {
    const {
        type = "page",
        touch = true,
...
export type UseMouseExReturn = ReturnType<typeof useMouseEx>;

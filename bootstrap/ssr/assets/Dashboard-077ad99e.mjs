  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--974a891e": animation.value.delay,
        "--633adce6": animation.value.duration
      } };
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-c9e05f88${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(`<!--]--></tbody><tfoot data-v-c9e05f88${_scopeId6}><tr data-v-c9e05f88${_scopeId6}><th data-v-c9e05f88${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-c9e05f88${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-c9e05f88${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-c9e05f88${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-c9e05f88${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
...
//# sourceMappingURL=Dashboard-077ad99e.mjs.map

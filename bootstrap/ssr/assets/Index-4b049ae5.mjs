...
import { a4 as VDivider, V as VBtn } from "../ssr.mjs";
import "dayjs";
              ...
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: unref(A)("ticket-allocator.ticket-categories.edit", item.raw.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(VBtn, {
                    to: unref(A)("ticket-allocator.ticket-categories.destroy", item.raw.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
...
//# sourceMappingURL=Index-4b049ae5.mjs.map

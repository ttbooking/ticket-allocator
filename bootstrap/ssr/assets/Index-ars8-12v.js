...
import { p as propsFactory, g as genericComponent, l as useProxiedModel, I as IN_BROWSER, f as useRender, r as VDefaultsProvider, F as focusableChildren, V as VBtn, T } from "../ssr.js";
import { V as VDataTable, a as VToolbar, b as VToolbarTitle, c as VSpacer } from "./VSpacer-CF5xw8oq.js";
import { a as useScopeId, V as VDivider } from "./scopeId-Cj_I4Lyt.js";
import { c as makeVOverlayProps, d as VDialogTransition, b as VOverlay, e as VSelect } from "./filter-C2_4DFDv.js";
import { f as forwardRefs } from "./VTextField-uOnLlm4x.js";
import { V as VCard, b as VCardTitle, a as VCardText, c as VCardActions } from "./VCard-Cr-GxL8I.js";
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(VBtn, {
                                            ...
                                            to: unref(T)("ticket-allocator.factors.create", { type: factorType.value }),
              ...
              [`item.active`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), {
                    as: "span",
                    href: unref(T)("ticket-allocator.factors.update", item.uuid),
                    method: "patch",
              ...
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: unref(T)("ticket-allocator.factors.edit", item.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(T)("ticket-allocator.factors.raise-priority", item.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(T)("ticket-allocator.factors.lower-priority", item.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(T)("ticket-allocator.factors.destroy", item.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
...
//# sourceMappingURL=Index-ars8-12v.js.map

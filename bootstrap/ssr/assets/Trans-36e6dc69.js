    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-21daf460${_scopeId}>Trans</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-21daf460${_scopeId}>`);
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody data-v-21daf460${_scopeId2}><!--[-->`);
                  ssrRenderList(operators.value, (operator) => {
                    _push3(`<tr data-v-21daf460${_scopeId2}><th data-v-21daf460${_scopeId2}>${ssrInterpolate(operator.name)}</th><td data-v-21daf460${_scopeId2}><!--[-->`);
...
const Trans_vue_vue_type_style_index_0_scoped_21daf460_lang = "";
...
const Trans = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-21daf460"]]);
export {
  Trans as default
};
//# sourceMappingURL=Trans-36e6dc69.js.map

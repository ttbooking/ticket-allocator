...
var _a, _b;
import { ref, onBeforeMount, onBeforeUnmount, computed, reactive, shallowRef, createVNode, mergeProps, watch, toRef, provide, withDirectives, resolveDirective, inject, nextTick, vShow, defineComponent, withCtx, createTextVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext, onMounted, isRef, onUnmounted, TransitionGroup } from "vue";
...
import { _ as _export_sfc, A, a as _sfc_main$5 } from "./Default-bb77db8c.mjs";
...
import { p as propsFactory, o as omit, m as makeVBtnProps, g as genericComponent, u as useTextColor, a as useRender, V as VBtn, b as animate, s as standardEasing, I as IconValue, c as makeComponentProps, d as makeTagProps, e as makeGroupProps, f as useRtl, h as useDisplay, i as useGroup, j as useResizeObserver, k as IN_BROWSER, l as VFadeTransition, n as VIcon, q as focusableChildren, r as clamp, t as makeDensityProps, v as useProxiedModel, w as useDensity, x as useBackgroundColor, y as provideDefaults, z as convertToUnit, A as keys, B as makeThemeProps, C as provideTheme, D as useLocale, E as makeGroupItemProps, F as makeLazyProps, G as useGroupItem, H as useSsrBoot, J as useLazy, M as MaybeTransition, K as VOverlay, L as makeVInputProps, N as makeVSelectionControlProps, O as useLoader, P as useFocus, Q as getUid, R as filterInputAttrs, S as VInput, T as VSelectionControl, U as LoaderSlot, W as VProgressCircular, X as VBtnToggle, Y as VBtnGroup, Z as VTable } from "../ssr.mjs";
import { V as VCard, a as VCardText } from "./VCard-3442df6d.mjs";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const compactPosition = computed(() => position.value < 1e5 ? position.value : position.value.toExponential(1));
    const categoryName = () => {
      var _a2, _b2;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--5cb2d92f": animation.value.delay,
        "--6d300330": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-afadbc8c>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-afadbc8c${_scopeId}><span class="title inline-block relative" data-v-afadbc8c${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-afadbc8c${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                            _push7(`<table data-v-afadbc8c${_scopeId6}><tbody data-v-afadbc8c${_scopeId6}><!--[-->`);
                                            ssrRenderList(cardContent.value, (value, key) => {
                                              _push7(`<tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-afadbc8c${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-afadbc8c${_scopeId6}><tbody data-v-afadbc8c${_scopeId6}><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("issued_on"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$dayjs(_ctx.ticket.created_at).format("lll"))}</td></tr><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("lifetime"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$dayjs(_ctx.ticket.created_at).fromNow(true))}</td></tr><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("current_weight"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(compactPosition.value)}</td></tr><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td></tr><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("delay"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay ? _ctx.$dayjs.duration(_ctx.ticket.delay, "s").humanize() : _ctx.$t("none"))}</td></tr><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("delayed_until"))}</th><td data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay ? _ctx.$dayjs(_ctx.ticket.created_at).add(_ctx.$dayjs.duration(_ctx.ticket.delay, "s")).format("lll") : "-")}</td></tr></tbody></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("tbody", null, [
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(_ctx.$dayjs(_ctx.ticket.created_at).format("lll")), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("lifetime")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.$dayjs(_ctx.ticket.created_at).fromNow(true)), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("current_weight")), 1),
                                                  createVNode("td", null, toDisplayString(compactPosition.value), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("complexity")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.complexity), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("delay")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.delay ? _ctx.$dayjs.duration(_ctx.ticket.delay, "s").humanize() : _ctx.$t("none")), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("delayed_until")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.delay ? _ctx.$dayjs(_ctx.ticket.created_at).add(_ctx.$dayjs.duration(_ctx.ticket.delay, "s")).format("lll") : "-"), 1)
                                                ])
                                              ])
                                            ])
                                          ];
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table class="table-fixed" data-v-afadbc8c${_scopeId6}><thead data-v-afadbc8c${_scopeId6}><tr data-v-afadbc8c${_scopeId6}><th class="w-1/3" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th class="text-center" data-v-afadbc8c${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("initial_weight"))} data-v-afadbc8c${_scopeId6}>W<sub data-v-afadbc8c${_scopeId6}>0</sub></em></th><th class="text-center" data-v-afadbc8c${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("weight_increment"))} data-v-afadbc8c${_scopeId6}>W<sub data-v-afadbc8c${_scopeId6}>i</sub></em></th><th class="text-center" data-v-afadbc8c${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("complexity"))} data-v-afadbc8c${_scopeId6}>C</em></th><th class="text-center" data-v-afadbc8c${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("delay_sec"))} data-v-afadbc8c${_scopeId6}>D</em></th></tr></thead><tbody data-v-afadbc8c${_scopeId6}><!--[-->`);
                                          ssrRenderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                            var _a4;
                                            _push7(`<tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown"))}</th><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(adjustments.initial_weight ?? 0)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(adjustments.weight_increment ?? 0)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(adjustments.complexity ?? 0)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(adjustments.delay ?? 0)}</td></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-afadbc8c${_scopeId6}><tr data-v-afadbc8c${_scopeId6}><th data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-afadbc8c${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
...
const Ticket_vue_vue_type_style_index_0_scoped_afadbc8c_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-afadbc8c"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-3e8a9909${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-3e8a9909${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-3e8a9909${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_3e8a9909_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3e8a9909"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-72f83347.mjs.map

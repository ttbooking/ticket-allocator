import { defineComponent, ref, computed, unref, withCtx, createVNode, TransitionGroup, openBlock, createBlock, Fragment, renderList, createTextVNode, nextTick, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { _ as _sfc_main$1 } from "./Default-48b0855a.js";
import { usePage, Head } from "@inertiajs/vue3";
import { uniqueId, sample, random, remove, reverse, shuffle } from "lodash";
import TransOperator from "./TransOperator-9ce33736.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-b7a2f76a${_scopeId}>Trans</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-b7a2f76a${_scopeId}>`);
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody${ssrRenderAttrs({ name: "operators" })}>`);
                  ssrRenderList(operators.value, (operator) => {
                    _push3(ssrRenderComponent(TransOperator, {
                      key: operator.id,
                      operator
...
const Trans_vue_vue_type_style_index_0_scoped_b7a2f76a_lang = "";
...
const Trans = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b7a2f76a"]]);
export {
  Trans as default
};
//# sourceMappingURL=Trans-95f24a53.js.map

  ...
  setup(__props) {
    ...
    const sortedOperators = computed(
      () => useCollect(
        ...
        }).where("online", true).orWhereHas("tickets").get()
      ).sortBy([
        ["online", "desc"],
        ["ready", "desc"],
        ["free_slots", "desc"],
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-d2e00195${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-d2e00195${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-d2e00195${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_d2e00195_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d2e00195"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-febcff60.js.map

...
import { _ as _sfc_main$1, I } from "./Default-c6ea5c65.js";
import { Head, Link } from "@inertiajs/vue3";
import { trans } from "laravel-vue-i18n";
import { V as VToolbar, a as VToolbarTitle, b as VSpacer } from "./VSpacer-e5671a7f.js";
import { p as propsFactory, $ as makeVOverlayProps, a0 as VDialogTransition, g as genericComponent, B as useProxiedModel, a1 as useScopeId, t as IN_BROWSER, f as useRender, W as VOverlay, a2 as VDefaultsProvider, a3 as forwardRefs, x as focusableChildren, a4 as VDivider, V as VBtn, a5 as VSelect, a6 as VCheckboxBtn } from "../ssr.js";
import { V as VCard, b as VCardTitle, a as VCardText, c as VCardActions } from "./VCard-ad9951df.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_data_table, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(VBtn, {
                                            ...
                                            to: unref(I)("ticket-allocator.factors.create", { type: factorType.value }),
              ...
              [`item.active`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), {
                    as: "span",
                    href: unref(I)("ticket-allocator.factors.update", item.raw.uuid),
                    method: "patch",
              ...
              [`item.type.name`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass({ italic: item.raw.type.excluded })}"${_scopeId2}>${ssrInterpolate(item.raw.type.name)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: { italic: item.raw.type.excluded }
                    }, toDisplayString(item.raw.type.name), 3)
                  ];
                }
              }),
              [`item.name`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span class="${ssrRenderClass({ italic: item.raw.type.excluded && !item.raw.display_name })}"${_scopeId2}>${ssrInterpolate(item.raw.name)}</span>`);
                } else {
                  return [
                    createVNode("span", {
                      class: { italic: item.raw.type.excluded && !item.raw.display_name }
                    }, toDisplayString(item.raw.name), 3)
                  ];
                }
              }),
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: unref(I)("ticket-allocator.factors.edit", item.raw.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(I)("ticket-allocator.factors.raise-priority", item.raw.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(I)("ticket-allocator.factors.lower-priority", item.raw.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(I)("ticket-allocator.factors.destroy", item.raw.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
...
//# sourceMappingURL=Index-c0f51d10.js.map

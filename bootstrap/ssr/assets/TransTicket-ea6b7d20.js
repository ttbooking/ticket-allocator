  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--19551dc6": _ctx.ticket.weight,
        "--e523cc76": animation.value.delay,
        "--8fae23dc": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "ticket-wrapper relative d-inline-block" }, _attrs, _cssVars))} data-v-279353ef>`);
...
const TransTicket_vue_vue_type_style_index_0_scoped_279353ef_lang = "";
...
const TransTicket = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-279353ef"]]);
export {
  TransTicket as default
};
//# sourceMappingURL=TransTicket-ea6b7d20.js.map

...
import { _ as _export_sfc, P, a as _sfc_main$5 } from "./Default-68ed1420.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--a6ac9cbc": unref(animation).delay,
        "--50166d15": unref(animation).duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-54456843>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-54456843${_scopeId}><span class="title inline-block relative" data-v-54456843${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof unref(cardContent) === "string") {
                                            _push7(`<div data-v-54456843${_scopeId6}>${unref(md).render(unref(cardContent))}</div>`);
                                          } else {
                                            _push7(`<table data-v-54456843${_scopeId6}><tbody data-v-54456843${_scopeId6}><!--[-->`);
                                            ssrRenderList(unref(cardContent), (value, key) => {
                                              _push7(`<tr data-v-54456843${_scopeId6}><th data-v-54456843${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-54456843${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, { value: "metrics" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-54456843${_scopeId6}><thead data-v-54456843${_scopeId6}><tr data-v-54456843${_scopeId6}><th data-v-54456843${_scopeId6}></th><th data-v-54456843${_scopeId6}>${ssrInterpolate(_ctx.$t("initial_weight"))}</th><th data-v-54456843${_scopeId6}>${ssrInterpolate(_ctx.$t("weight_increment"))}</th><th data-v-54456843${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><th data-v-54456843${_scopeId6}>${ssrInterpolate(_ctx.$t("delay"))}</th></tr></thead><tbody data-v-54456843${_scopeId6}><!--[-->`);
                                          ssrRenderList(__props.ticket.metrics ?? [], (adjustments, factorUuid) => {
                                            _push7(`<tr data-v-54456843${_scopeId6}><th data-v-54456843${_scopeId6}>${ssrInterpolate(factorUuid)}</th><!--[-->`);
                                            ssrRenderList(adjustments, (adjustment, metric) => {
                                              _push7(`<td data-v-54456843${_scopeId6}>${ssrInterpolate(adjustment)}</td>`);
                                            });
                                            _push7(`<!--]--></tr>`);
                                          });
                                          _push7(`<!--]--></tbody></table>`);
...
const Ticket_vue_vue_type_style_index_0_scoped_54456843_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-54456843"]]);
  ...
  constructor() {
    ...
    __publicField(this, "adjustMetrics", ({ uuid, factorUuid, adjustments }) => {
      ...
      for (const [metric, adjustment] of Object.entries(adjustments)) {
        metrics[metric] = Math.min(0, (((_b2 = this.find(uuid)) == null ? void 0 : _b2[metric]) ?? 0) + adjustment);
      }
...
//# sourceMappingURL=Dashboard-ac97def5.mjs.map

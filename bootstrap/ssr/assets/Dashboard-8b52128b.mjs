  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--6e24197e": unref(animation).delay,
        "--89b259d4": unref(animation).duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-9d6f3428>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-9d6f3428${_scopeId}><span class="title inline-block relative" data-v-9d6f3428${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof unref(cardContent) === "string") {
                                            _push7(`<div data-v-9d6f3428${_scopeId6}>${unref(md).render(unref(cardContent))}</div>`);
                                          } else {
                                            _push7(`<table data-v-9d6f3428${_scopeId6}><tbody data-v-9d6f3428${_scopeId6}><!--[-->`);
                                            ssrRenderList(unref(cardContent), (value, key) => {
                                              _push7(`<tr data-v-9d6f3428${_scopeId6}><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-9d6f3428${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-9d6f3428${_scopeId6}><thead data-v-9d6f3428${_scopeId6}><tr data-v-9d6f3428${_scopeId6}><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("initial_weight"))}</th><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("weight_increment"))}</th><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("delay"))}</th></tr></thead><tbody data-v-9d6f3428${_scopeId6}><!--[-->`);
                                          ssrRenderList(__props.ticket.metrics ?? [], (adjustments, factorUuid) => {
                                            _push7(`<tr data-v-9d6f3428${_scopeId6}><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(factorUuid)}</th><!--[-->`);
                                            ssrRenderList(adjustments, (adjustment, metric) => {
                                              _push7(`<td data-v-9d6f3428${_scopeId6}>${ssrInterpolate(adjustment)}</td>`);
                                            });
                                            _push7(`<!--]--></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-9d6f3428${_scopeId6}><tr data-v-9d6f3428${_scopeId6}><th data-v-9d6f3428${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td data-v-9d6f3428${_scopeId6}>${ssrInterpolate(__props.ticket.initial_weight)}</td><td data-v-9d6f3428${_scopeId6}>${ssrInterpolate(__props.ticket.weight_increment)}</td><td data-v-9d6f3428${_scopeId6}>${ssrInterpolate(__props.ticket.complexity)}</td><td data-v-9d6f3428${_scopeId6}>${ssrInterpolate(__props.ticket.delay)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("thead", null, [
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("factor")), 1),
                                                  createVNode("th", null, toDisplayString(_ctx.$t("initial_weight")), 1),
                                                  createVNode("th", null, toDisplayString(_ctx.$t("weight_increment")), 1),
                                              ...
                                              createVNode("tbody", null, [
                                                (openBlock(true), createBlock(Fragment, null, renderList(__props.ticket.metrics ?? [], (adjustments, factorUuid) => {
                                                  return openBlock(), createBlock("tr", { key: factorUuid }, [
                                                    ...
                                                    (openBlock(true), createBlock(Fragment, null, renderList(adjustments, (adjustment, metric) => {
                                                      return openBlock(), createBlock("td", { key: metric }, toDisplayString(adjustment), 1);
                                                    }), 128))
                                                  ]);
                                                }), 128))
                                              ]),
                                              createVNode("tfoot", null, [
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(__props.ticket.initial_weight), 1),
                                                  createVNode("td", null, toDisplayString(__props.ticket.weight_increment), 1),
                                                  createVNode("td", null, toDisplayString(__props.ticket.complexity), 1),
                                                  createVNode("td", null, toDisplayString(__props.ticket.delay), 1)
                                                ])
                                              ])
                                            ])
                                          ];
...
const Ticket_vue_vue_type_style_index_0_scoped_9d6f3428_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9d6f3428"]]);
...
class TicketRepository extends Repository {
  constructor() {
    ...
    __publicField(this, "adjustMetrics", ({ uuid, factorUuid, adjustments }) => {
      var _a2, _b2;
      const perFactorMetrics = ((_a2 = this.find(uuid)) == null ? void 0 : _a2.metrics) ?? {};
      perFactorMetrics[factorUuid] = adjustments;
      const metrics = {};
      for (const [metric, adjustment] of Object.entries(adjustments)) {
        metrics[metric] = Math.max(0, (((_b2 = this.find(uuid)) == null ? void 0 : _b2[metric]) ?? 0) + adjustment);
      }
...
//# sourceMappingURL=Dashboard-8b52128b.mjs.map

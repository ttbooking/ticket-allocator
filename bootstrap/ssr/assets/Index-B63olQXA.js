...
import "./filter-DoTxI0C-.js";
import "./VTextField-uOnLlm4x.js";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VDataTable, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(_component_v_btn_ex, {
                          to: unref(T)("ticket-allocator.operators.discover"),
                          method: "put",
                          color: "primary",
                          dark: ""
                        }, {
                        ...
                        _push4(ssrRenderComponent(VBtn, {
                          to: unref(T)("ticket-allocator.operators.create"),
                          color: "primary",
                          dark: ""
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
              ...
              [`item.name`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`${ssrInterpolate(item.name ?? ((_a = item.user) == null ? void 0 : _a.name) ?? "")}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(item.name ?? ((_b = item.user) == null ? void 0 : _b.name) ?? ""), 1)
                  ];
                }
              }),
              [`item.ticket_limit`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(item.ticket_limit ?? "∞")}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(item.ticket_limit ?? "∞"), 1)
                  ];
                }
              }),
              [`item.complexity_limit`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(item.complexity_limit ?? "∞")}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(item.complexity_limit ?? "∞"), 1)
                  ];
                }
              }),
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: unref(T)("ticket-allocator.operators.edit", item.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: unref(T)("ticket-allocator.operators.destroy", item.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
              ...
              createVNode("div", null, [
                createVNode(VDataTable, {
                  ...
                  [`item.name`]: withCtx(({ item }) => {
                    var _a;
                    return [
                      createTextVNode(toDisplayString(item.name ?? ((_a = item.user) == null ? void 0 : _a.name) ?? ""), 1)
                    ];
                  }),
...
//# sourceMappingURL=Index-B63olQXA.js.map

                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VBtn, {
                          to: _ctx.route("ticket-allocator.ticket-categories.create"),
                          color: "primary",
                          dark: ""
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
              ...
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: _ctx.route("ticket-allocator.ticket-categories.edit", item.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: _ctx.route("ticket-allocator.ticket-categories.destroy", item.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
...
//# sourceMappingURL=Index-0a9ef2f2.js.map

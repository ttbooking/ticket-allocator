import { inject, provide, shallowRef, onDeactivated, onActivated, computed, onBeforeUnmount, ref, reactive, onMounted, createVNode, watch, toRef, nextTick, onBeforeMount, Fragment, mergeProps, Transition, useSSRContext, defineComponent, withCtx, unref, toDisplayString, renderSlot } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { Link } from "@inertiajs/vue3";
import { getActiveLanguage } from "laravel-vue-i18n";
import { p as propsFactory, E as getUid, aV as getCurrentInstance, s as useResizeObserver, o as convertToUnit, aW as findChildrenWithProvide, m as makeComponentProps, b as makeThemeProps, g as genericComponent, c as provideTheme, u as useRtl, f as useRender, a as makeTagProps, l as useSsrBoot, aX as CircularBuffer, a9 as makeBorderProps, ab as makeElevationProps, af as makeRoundedProps, aj as useBorder, T as useBackgroundColor, am as useElevation, r as useDisplay, ap as useRounded, aY as useRouter, B as useProxiedModel, a1 as useScopeId, aZ as toPhysical, U as provideDefaults, d as useLocale, aK as VList, aL as VListItem } from "../ssr.js";
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VListItem, {
                          to: unref(I)("ticket-allocator.index"),
                          "prepend-icon": "mdi-monitor-dashboard",
                          title: _ctx.$t("dashboard"),
                          value: "dashboard"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: unref(I)("ticket-allocator.operators.index"),
                          "prepend-icon": "mdi-account",
                          title: _ctx.$t("operators"),
                          value: "operators"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: unref(I)("ticket-allocator.teams.index"),
                          "prepend-icon": "mdi-account-group",
                          title: _ctx.$t("teams"),
                          value: "teams"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: unref(I)("ticket-allocator.ticket-categories.index"),
                          "prepend-icon": "mdi-ticket",
                          title: _ctx.$t("ticket_categories"),
                          value: "ticket-categories"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: unref(I)("ticket-allocator.factors.index"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    href: unref(I)("ticket-allocator.index"),
...
//# sourceMappingURL=Default-c6ea5c65.js.map

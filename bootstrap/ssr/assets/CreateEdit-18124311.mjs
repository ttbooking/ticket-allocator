import { ref, inject, onBeforeMount, defineComponent, computed, unref, withCtx, createVNode, toDisplayString, withDirectives, vModelText, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, createTextVNode, withModifiers, useSSRContext } from "vue";
import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderVNode } from "vue/server-renderer";
import { a as _sfc_main$1, A } from "./Default-b407fd61.mjs";
import { useForm, Head, Link } from "@inertiajs/vue3";
import { V as VForm } from "./VForm-4ecc29da.mjs";
import { V as VContainer, a as VRow, b as VCol } from "./VRow-086e8cde.mjs";
import { V as VCheckbox, a as VTextarea } from "./VTextarea-6b958ce5.mjs";
...
function useDynamicComponent(name) {
  ...
  const props = inject("appProps");
  onBeforeMount(async () => {
    if (name && (props == null ? void 0 : props.resolveComponent)) {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (!!unref(formComponent)) {
                                      ssrRenderVNode(_push6, createVNode(resolveDynamicComponent(unref(formComponent)), {
...
//# sourceMappingURL=CreateEdit-18124311.mjs.map

import { defineComponent, computed, ref, onBeforeMount, unref, withCtx, createVNode, toDisplayString, withDirectives, vModelText, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, createTextVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const factorTypeComponent = computed(() => {
      var _a2, _b2;
      return ((_a2 = props.factor) == null ? void 0 : _a2.type.component) ?? ((_b2 = props.factorType) == null ? void 0 : _b2.component) ?? null;
    });
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    if (!!formComponent.value) {
                                      ssrRenderVNode(_push6, createVNode(resolveDynamicComponent(formComponent.value), {
                                    ...
                                    return [
                                      !!formComponent.value ? (openBlock(), createBlock(resolveDynamicComponent(formComponent.value), {
                                        key: 0,
                                        modelValue: unref(form).config,
                                        "onUpdate:modelValue": ($event) => unref(form).config = $event,
                                        entries: _ctx.entries
...
//# sourceMappingURL=CreateEdit-5f6ddce8.mjs.map

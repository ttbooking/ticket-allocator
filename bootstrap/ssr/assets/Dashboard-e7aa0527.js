...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-b61a3cdb><td class="status" data-v-b61a3cdb>`);
      ssrRenderSlot(_ctx.$slots, "status", {}, null, _push, _parent);
      _push(`</td><td class="name font-weight-bold" data-v-b61a3cdb>`);
      ssrRenderSlot(_ctx.$slots, "name", {}, null, _push, _parent);
      _push(`</td><td class="load text-center" data-v-b61a3cdb>`);
      ...
      _push(`</td><td class="complexity text-center" data-v-b61a3cdb>`);
      ...
      _push(`</td><td class="${ssrRenderClass([{ collapsed: unref(collapsed) }, "tickets pt-1"])}" data-v-b61a3cdb>`);
      _push(ssrRenderComponent(TicketPool, { tickets: _ctx.tickets }, null, _parent));
      _push(`</td><td class="more text-center" data-v-b61a3cdb>`);
      _push(ssrRenderComponent(VBtn, {
        size: "x-small",
        variant: "tonal",
        icon: moreIcon.value,
...
const TicketRow_vue_vue_type_style_index_0_scoped_b61a3cdb_lang = "";
...
const TicketRow = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-b61a3cdb"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const sortedTickets = refThrottled(
      computed(
        () => ticketRepo.value.unbound().with("category").where("meta", (meta) => {
          return Object.entries(filters.value).reduce((passes, x) => {
            const [filter, entries] = x;
            const prop = meta == null ? void 0 : meta[filter];
            console.log(filters.value);
            const pass = prop === void 0 || entries.includes(prop.toString());
            console.log(`${filter} ${pass ? "pass" : "nopass"} ${prop}`);
            return passes && pass;
          }, true);
        }).orderBy(mode.value, "desc").get()
      ),
      750
    );
    const api = useSupervisorApi();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-0de9ddf7${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-0de9ddf7${_scopeId}>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VAutocomplete, {
                                  modelValue: filters.value[matcher],
                                  "onUpdate:modelValue": ($event) => filters.value[matcher] = $event,
                                  multiple: "",
                                  clearable: "",
                                  chips: "",
                                  "closable-chips": "",
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-0de9ddf7${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_0de9ddf7_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-0de9ddf7"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-e7aa0527.js.map

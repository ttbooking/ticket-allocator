import { inject, provide, shallowRef, onDeactivated, onActivated, computed, onBeforeUnmount, ref, reactive, onMounted, createVNode, watch, toRef, onBeforeMount, Fragment, mergeProps, Transition, nextTick, useSSRContext, defineComponent, withCtx, unref, toDisplayString, renderSlot } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderSlot } from "vue/server-renderer";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { Link } from "@inertiajs/vue3";
import { getActiveLanguage } from "laravel-vue-i18n";
import { p as propsFactory, E as getUid, aW as getCurrentInstance, s as useResizeObserver, o as convertToUnit, aX as findChildrenWithProvide, m as makeComponentProps, b as makeThemeProps, g as genericComponent, c as provideTheme, u as useRtl, f as useRender, a as makeTagProps, l as useSsrBoot, aY as CircularBuffer, ab as makeBorderProps, ad as makeElevationProps, ah as makeRoundedProps, al as useBorder, U as useBackgroundColor, ao as useElevation, r as useDisplay, ar as useRounded, aZ as useRouter, B as useProxiedModel, a3 as useScopeId, a_ as toPhysical, a$ as useToggleScope, W as provideDefaults, d as useLocale, aL as VList, aM as VListItem } from "../ssr.js";
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VListItem, {
                          to: _ctx.route("ticket-allocator.index"),
                          "prepend-icon": "mdi-monitor-dashboard",
                          title: _ctx.$t("dashboard"),
                          value: "dashboard"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: _ctx.route("ticket-allocator.operators.index"),
                          "prepend-icon": "mdi-account",
                          title: _ctx.$t("operators"),
                          value: "operators"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: _ctx.route("ticket-allocator.teams.index"),
                          "prepend-icon": "mdi-account-group",
                          title: _ctx.$t("teams"),
                          value: "teams"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: _ctx.route("ticket-allocator.ticket-categories.index"),
                          "prepend-icon": "mdi-ticket",
                          title: _ctx.$t("ticket_categories"),
                          value: "ticket-categories"
                        }, null, _parent4, _scopeId3));
                        _push4(ssrRenderComponent(VListItem, {
                          to: _ctx.route("ticket-allocator.factors.index"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    href: _ctx.route("ticket-allocator.index"),
...
//# sourceMappingURL=Default-a3b27c0a.js.map

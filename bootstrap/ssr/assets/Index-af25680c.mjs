...
import { a as _sfc_main$1, P } from "./Default-a02f831f.mjs";
import { Head, Link } from "@inertiajs/vue3";
import { wTrans } from "laravel-vue-i18n";
import { V as VToolbar, a as VToolbarTitle, b as VSpacer } from "./VToolbar-5392ad8f.mjs";
import { am as VDivider, X as VBtn, an as VCheckboxBtn } from "../ssr.mjs";
import "pinia";
import "pinia-orm";
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_data_table, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(unref(Link), {
                          href: unref(P)("ticket-allocator.teams.create")
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
              ...
              [`item.active`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), {
                    as: "span",
                    href: unref(P)("ticket-allocator.teams.update", item.raw.uuid),
                    method: "patch",
              ...
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), {
                    href: unref(P)("ticket-allocator.teams.edit", item.raw.uuid)
                  }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(ssrRenderComponent(unref(Link), {
                    as: "span",
                    href: unref(P)("ticket-allocator.teams.destroy", item.raw.uuid),
                    method: "delete"
                  }, {
                    default: withCtx((_2, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
...
//# sourceMappingURL=Index-af25680c.mjs.map

  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--1911d36b": animation.value.delay,
        "--8bebeaa8": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-a4eb707f>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-a4eb707f${_scopeId}><span class="title inline-block relative" data-v-a4eb707f${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-a4eb707f${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                            _push7(`<table data-v-a4eb707f${_scopeId6}><tbody data-v-a4eb707f${_scopeId6}><!--[-->`);
                                            ssrRenderList(cardContent.value, (value, key) => {
                                              _push7(`<tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-a4eb707f${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-a4eb707f${_scopeId6}><tbody data-v-a4eb707f${_scopeId6}><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("issued_on"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(createdAt.value.format("lll"))}</td></tr><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("lifetime"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(createdAt.value.fromNow(true))}</td></tr><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("current_weight"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(compactPosition.value)}</td></tr><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td></tr><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("delay"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay ? delay.value.humanize() : _ctx.$t("none"))}</td></tr><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("delayed_until"))}</th><td data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay ? createdAt.value.add(delay.value).format("lll") : "-")}</td></tr></tbody></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("tbody", null, [
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(createdAt.value.format("lll")), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("lifetime")), 1),
                                                  createVNode("td", null, toDisplayString(createdAt.value.fromNow(true)), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                ...
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.delay ? delay.value.humanize() : _ctx.$t("none")), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("delayed_until")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.delay ? createdAt.value.add(delay.value).format("lll") : "-"), 1)
                                                ])
                                              ])
                                            ])
                                          ];
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table class="table-fixed" data-v-a4eb707f${_scopeId6}><thead data-v-a4eb707f${_scopeId6}><tr data-v-a4eb707f${_scopeId6}><th class="w-1/3" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th class="text-center" data-v-a4eb707f${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("initial_weight"))} data-v-a4eb707f${_scopeId6}>W<sub data-v-a4eb707f${_scopeId6}>0</sub></em></th><th class="text-center" data-v-a4eb707f${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("weight_increment"))} data-v-a4eb707f${_scopeId6}>W<sub data-v-a4eb707f${_scopeId6}>i</sub></em></th><th class="text-center" data-v-a4eb707f${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("complexity"))} data-v-a4eb707f${_scopeId6}>C</em></th><th class="text-center" data-v-a4eb707f${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("delay_sec"))} data-v-a4eb707f${_scopeId6}>D</em></th></tr></thead><tbody data-v-a4eb707f${_scopeId6}><!--[-->`);
                                          ssrRenderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                            var _a4;
                                            _push7(`<tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown"))}</th><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(adjustments.initial_weight ?? 0)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(adjustments.weight_increment ?? 0)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(adjustments.complexity ?? 0)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(adjustments.delay ?? 0)}</td></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-a4eb707f${_scopeId6}><tr data-v-a4eb707f${_scopeId6}><th data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-a4eb707f${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
...
const Ticket_vue_vue_type_style_index_0_scoped_a4eb707f_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a4eb707f"]]);
...
//# sourceMappingURL=Dashboard-92f1b7d7.mjs.map

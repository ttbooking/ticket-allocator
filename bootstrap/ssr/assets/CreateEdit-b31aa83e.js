...
import { V as VForm } from "./VForm-6571a5f4.js";
...
import { V as VAutocomplete } from "./VAutocomplete-b1196406.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const form = useForm({
      ...
      matching: ((_f = props.team) == null ? void 0 : _f.matching) ?? {}
    });
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(VCol, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(ssrRenderComponent(VAutocomplete, {
                                        modelValue: unref(form).matching[matcher],
                                        "onUpdate:modelValue": ($event) => unref(form).matching[matcher] = $event,
                                        multiple: "",
                                        clearable: "",
                                        chips: "",
                                        "closable-chips": "",
...
//# sourceMappingURL=CreateEdit-b31aa83e.js.map

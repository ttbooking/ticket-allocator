...
import TransOperator from "./TransOperator-fa336f38.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-28f42777${_scopeId}>Trans</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-28f42777${_scopeId}>`);
...
const Trans_vue_vue_type_style_index_0_scoped_28f42777_lang = "";
...
const Trans = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-28f42777"]]);
export {
  Trans as default
};
//# sourceMappingURL=Trans-6f5fdc95.js.map

  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--1ff1f12a": animation.value.delay,
        "--cacf52a8": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-988e55d0>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-988e55d0${_scopeId}><span class="title inline-block relative" data-v-988e55d0${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-988e55d0${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                            _push7(`<table data-v-988e55d0${_scopeId6}><tbody data-v-988e55d0${_scopeId6}><!--[-->`);
                                            ssrRenderList(cardContent.value, (value, key) => {
                                              _push7(`<tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-988e55d0${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-988e55d0${_scopeId6}><tbody data-v-988e55d0${_scopeId6}><tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("issued_on"))}</th><td data-v-988e55d0${_scopeId6}>${ssrInterpolate(createdAtInfo.value)}</td></tr>`);
                                          if (_ctx.ticket.delay) {
                                            _push7(`<tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("delayed_until"))}</th><td data-v-988e55d0${_scopeId6}>${ssrInterpolate(delayedUntilInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          _push7(`<tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("current_weight"))}</th><td data-v-988e55d0${_scopeId6}>${ssrInterpolate(compact(_ctx.ticket.weight))}</td></tr><tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><td data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td></tr></tbody></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("tbody", null, [
                                                ...
                                                _ctx.ticket.delay ? (openBlock(), createBlock("tr", { key: 0 }, [
                                                ...
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(compact(_ctx.ticket.weight)), 1)
                                                ]),
                                                createVNode("tr", null, [
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table class="table-fixed" data-v-988e55d0${_scopeId6}><thead data-v-988e55d0${_scopeId6}><tr data-v-988e55d0${_scopeId6}><th class="w-1/3" data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th class="text-center" data-v-988e55d0${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("initial_weight"))} data-v-988e55d0${_scopeId6}>W<sub data-v-988e55d0${_scopeId6}>0</sub></em></th><th class="text-center" data-v-988e55d0${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("weight_increment"))} data-v-988e55d0${_scopeId6}>W<sub data-v-988e55d0${_scopeId6}>i</sub></em></th><th class="text-center" data-v-988e55d0${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("complexity"))} data-v-988e55d0${_scopeId6}>C</em></th><th class="text-center" data-v-988e55d0${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("delay_sec"))} data-v-988e55d0${_scopeId6}>D</em></th></tr></thead><tbody data-v-988e55d0${_scopeId6}><!--[-->`);
                                          ssrRenderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                            var _a4;
                                            _push7(`<tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown"))}</th><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(adjustments.initial_weight ?? 0)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(adjustments.weight_increment ?? 0)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(adjustments.complexity ?? 0)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(adjustments.delay ?? 0)}</td></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-988e55d0${_scopeId6}><tr data-v-988e55d0${_scopeId6}><th data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-988e55d0${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
...
const Ticket_vue_vue_type_style_index_0_scoped_988e55d0_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-988e55d0"]]);
...
//# sourceMappingURL=Dashboard-ff76fc13.mjs.map

...
var _a, _b;
import { ref, computed, reactive, shallowRef, watch, createVNode, mergeProps, toRef, provide, withDirectives, resolveDirective, inject, nextTick, vShow, defineComponent, withCtx, createTextVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext, onMounted, isRef, TransitionGroup } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-c055c156${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-c055c156${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-c055c156${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_c055c156_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c055c156"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-3eb770c4.mjs.map

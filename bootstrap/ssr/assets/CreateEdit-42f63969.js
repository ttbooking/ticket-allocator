...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function submit() {
      props.ticketCategory ? form.put(route("ticket-allocator.ticket-categories.update", props.ticketCategory.uuid)) : form.post(route("ticket-allocator.ticket-categories.store"));
    }
...
//# sourceMappingURL=CreateEdit-42f63969.js.map

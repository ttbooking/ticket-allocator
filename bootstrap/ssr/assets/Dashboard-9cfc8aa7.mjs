...
var _a, _b;
import { ref, computed, reactive, createVNode, withDirectives, resolveDirective, watch, mergeProps, toRef, provide, inject, nextTick, vShow, defineComponent, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext, onMounted, isRef, TransitionGroup } from "vue";
...
import { _ as _export_sfc, P, a as _sfc_main$5 } from "./Default-b1f68e08.mjs";
...
import { g as genericComponent, m as makeComponentProps, p as provideDefaults, u as useRender, c as createSimpleFunctional, I as IconValue, a as makeDensityProps, V as VAvatar, b as VDefaultsProvider, R as Ripple, d as makeBorderProps, e as makeDimensionProps, f as makeElevationProps, h as makeLoaderProps, i as makeLocationProps, j as makePositionProps, k as makeRoundedProps, l as makeRouterProps, n as makeTagProps, o as makeThemeProps, q as makeVariantProps, r as provideTheme, s as useBorder, t as useVariant, v as useDensity, w as useDimension, x as useElevation, y as useLoader, z as useLocation, A as usePosition, B as useRounded, C as useLink, D as VImg, L as LoaderSlot, E as genOverlays, F as propsFactory, G as makeGroupProps, H as useRtl, J as useDisplay, K as useGroup, M as useResizeObserver, N as IN_BROWSER, O as VFadeTransition, P as VIcon, Q as focusableChildren, S as clamp, T as omit, U as makeVBtnProps, W as useTextColor, X as VBtn, Y as animate, Z as standardEasing, _ as useProxiedModel, $ as useBackgroundColor, a0 as convertToUnit, a1 as keys, a2 as useLocale, a3 as makeGroupItemProps, a4 as makeLazyProps, a5 as useGroupItem, a6 as useSsrBoot, a7 as useLazy, a8 as MaybeTransition, a9 as VOverlay, aa as makeVInputProps, ab as makeSelectionControlProps, ac as useFocus, ad as getUid, ae as filterInputAttrs, af as VInput, ag as VSelectionControl, ah as VProgressCircular, ai as VBtnToggle, aj as VBtnGroup, ak as VTable } from "../ssr.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--3affdc42": unref(animation).delay,
        "--2d60be75": unref(animation).duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-a0ddad6e>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-a0ddad6e${_scopeId}><span class="title inline-block relative" data-v-a0ddad6e${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof unref(cardContent) === "string") {
                                            _push7(`<div data-v-a0ddad6e${_scopeId6}>${unref(md).render(unref(cardContent))}</div>`);
                                          } else {
                                            _push7(`<table data-v-a0ddad6e${_scopeId6}><tbody data-v-a0ddad6e${_scopeId6}><!--[-->`);
                                            ssrRenderList(unref(cardContent), (value, key) => {
                                              _push7(`<tr data-v-a0ddad6e${_scopeId6}><th data-v-a0ddad6e${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-a0ddad6e${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
...
const Ticket_vue_vue_type_style_index_0_scoped_a0ddad6e_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-a0ddad6e"]]);
...
//# sourceMappingURL=Dashboard-9cfc8aa7.mjs.map

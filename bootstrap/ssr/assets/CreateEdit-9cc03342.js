import { shallowRef, inject, onBeforeMount, defineComponent, computed, unref, withCtx, createVNode, toDisplayString, withDirectives, vModelText, resolveDynamicComponent, createTextVNode, openBlock, createBlock, createCommentVNode, withModifiers, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function submit() {
      props.factor ? form.put(route("ticket-allocator.factors.update", props.factor.uuid)) : form.post(route("ticket-allocator.factors.store"));
    }
...
//# sourceMappingURL=CreateEdit-9cc03342.js.map

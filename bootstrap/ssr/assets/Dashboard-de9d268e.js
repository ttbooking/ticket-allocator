...
var _a, _b;
import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, nextTick, mergeProps, Fragment, toRef, onBeforeMount, onBeforeUnmount, reactive, defineComponent, withCtx, createTextVNode, toDisplayString, unref, openBlock, createBlock, renderList, createCommentVNode, useSSRContext, onMounted, withModifiers, resolveDynamicComponent, renderSlot, isRef, onUnmounted } from "vue";
...
import { A, _ as _sfc_main$5 } from "./Default-298dad79.js";
...
import { k as keys, p as propsFactory, m as makeComponentProps, a as makeTagProps, b as makeThemeProps, g as genericComponent, c as provideTheme, u as useRtl, d as useLocale, e as useGroup, V as VBtn, f as useRender, h as makeGroupItemProps, i as useGroupItem, j as convertToUnit, I as IconValue, l as makeDisplayProps, n as makeGroupProps, o as useDisplay, q as useResizeObserver, r as IN_BROWSER, s as VIcon, t as focusableChildren, v as clamp, w as useProxiedModel, x as useLoader, y as getUid, z as filterInputAttrs, L as LoaderSlot, A as VProgressCircular, B as omit, C as makeVBtnProps, D as useTextColor, E as makeDensityProps, F as useDensity, G as useBackgroundColor, H as provideDefaults, J as isObject, K as VBtnToggle, M as VBtnGroup } from "../ssr.js";
import { m as makeLazyProps, u as useLazy, V as VOverlay } from "./filter-fef2682e.js";
import { V as VCard, a as VCardText } from "./VCard-2d8613be.js";
import { m as makeVInputProps, u as useFocus, V as VInput, a as animate, s as standardEasing } from "./VTextField-467c3200.js";
import { M as MaybeTransition, V as VFadeTransition, a as VScaleTransition } from "./VGrid-8fb1012f.js";
import { u as useSsrBoot } from "./scopeId-3197276f.js";
...
import { V as VContainer } from "./VContainer-268a3571.js";
import { V as VRow, a as VCol } from "./VRow-01570148.js";
import { m as makeVSelectionControlProps, V as VSelectionControl } from "./VCheckboxBtn-0a66328c.js";
import { V as VAutocomplete } from "./VAutocomplete-dddd877d.js";
import { V as VTable } from "./VTable-a709fbf7.js";
import "@vue/shared";
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const reservedUntilInfo = computed(
      () => reservedUntil.value ? `${reservedUntil.value.format("lll")} (${t("time_left", { time: reservedUntil.value.fromNow(true) })})` : null
    );
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--ce5ffc88": animation.value.delay,
        "--4e99eebb": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-e57ba096>`);
      _push(ssrRenderComponent(VBtn, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`<span class="text-white overflow-hidden" data-v-e57ba096${_scopeId}><span class="title inline-block relative" data-v-e57ba096${_scopeId}>${ssrInterpolate(title())}</span></span>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-e57ba096${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                            _push7(`<table data-v-e57ba096${_scopeId6}><tbody data-v-e57ba096${_scopeId6}><!--[-->`);
                                            ssrRenderList(cardContent.value, ([key, value]) => {
                                              _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-e57ba096${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-e57ba096${_scopeId6}><tbody data-v-e57ba096${_scopeId6}><tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("issued_on"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(createdAtInfo.value)}</td></tr>`);
                                          if (delayedUntil.value.isAfter(_ctx.$dayjs())) {
                                            _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("delayed_until"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(delayedUntilInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (boundAt.value) {
                                            _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("bound_at"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(boundAtInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (reservedUntil.value && reservedUntil.value.isAfter(_ctx.$dayjs())) {
                                            _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("reserved_until"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(reservedUntilInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (acceptedAt.value) {
                                            _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("accepted_at"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(acceptedAtInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("current_weight"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(currentWeightInfo.value)}</td></tr><tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><td data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity + " " + unref(t)("units"))}</td></tr></tbody></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("tbody", null, [
                                                ...
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.complexity + " " + unref(t)("units")), 1)
                                                ])
                                              ])
                                            ])
                                          ];
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table class="table-fixed" data-v-e57ba096${_scopeId6}><thead data-v-e57ba096${_scopeId6}><tr data-v-e57ba096${_scopeId6}><th class="w-1/3" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th class="text-center" data-v-e57ba096${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("initial_weight"))} data-v-e57ba096${_scopeId6}>W<sub data-v-e57ba096${_scopeId6}>0</sub></em></th><th class="text-center" data-v-e57ba096${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("weight_increment"))} data-v-e57ba096${_scopeId6}>W<sub data-v-e57ba096${_scopeId6}>i</sub></em></th><th class="text-center" data-v-e57ba096${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("complexity"))} data-v-e57ba096${_scopeId6}>C</em></th><th class="text-center" data-v-e57ba096${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("delay_sec"))} data-v-e57ba096${_scopeId6}>D</em></th><th class="text-center" data-v-e57ba096${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("reservation_sec"))} data-v-e57ba096${_scopeId6}>R</em></th></tr></thead><tbody data-v-e57ba096${_scopeId6}><!--[-->`);
                                          ssrRenderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                            var _a4;
                                            _push7(`<tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown"))}</th><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(adjustments.initial_weight ?? 0)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(adjustments.weight_increment ?? 0)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(adjustments.complexity ?? 0)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(adjustments.delay ?? 0)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(adjustments.reservation ?? 0)}</td></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-e57ba096${_scopeId6}><tr data-v-e57ba096${_scopeId6}><th data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td><td class="text-right" data-v-e57ba096${_scopeId6}>${ssrInterpolate(_ctx.ticket.reservation)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
...
const Ticket_vue_vue_type_style_index_0_scoped_e57ba096_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-e57ba096"]]);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-10353e41${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-10353e41${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<thead class="align-top" data-v-10353e41${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_10353e41_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10353e41"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-de9d268e.js.map

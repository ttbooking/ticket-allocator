...
import { _ as _sfc_main$5 } from "./Default-C_EDuwmX.js";
...
import { k as keys, p as propsFactory, m as makeComponentProps, a as makeTagProps, b as makeThemeProps, g as genericComponent, c as provideTheme, u as useRtl, d as useLocale, e as useGroup, V as VBtn, f as useRender, h as makeGroupItemProps, i as useGroupItem, j as convertToUnit, l as useProxiedModel, n as useLoader, o as getUid, q as filterInputAttrs, r as VDefaultsProvider, s as VIcon, L as LoaderSlot, t as VProgressCircular, v as omit, w as makeVBtnProps, x as useTextColor, y as makeDensityProps, z as useDensity, A as useBackgroundColor, B as provideDefaults, C as isObject, T, D as VBtnToggle, E as VBtnGroup } from "../ssr.js";
import { m as makeLazyProps, u as useLazy, a as makeVSlideGroupProps, V as VSlideGroup, b as VOverlay } from "./filter-DoTxI0C-.js";
import { V as VCard, a as VCardText } from "./VCard-Cr-GxL8I.js";
import { m as makeVInputProps, u as useFocus, V as VInput, f as forwardRefs, a as animate, s as standardEasing } from "./VTextField-uOnLlm4x.js";
import { u as useSsrBoot } from "./scopeId-Cj_I4Lyt.js";
import { M as MaybeTransition, V as VScaleTransition } from "./VGrid-BrK3U4-N.js";
...
import { m as makeVSelectionControlProps, V as VSelectionControl } from "./VCheckboxBtn-C19WC2gs.js";
import { V as VAutocomplete } from "./VAutocomplete-WaZNdR6B.js";
import { V as VTable } from "./VTable-DTLEl5Oo.js";
import "@vue/shared";
...
function useSupervisorApi() {
  async function ready(operatorUuid, ready2) {
    return await window.axios.patch(T("ticket-allocator.operators.ready", operatorUuid), { ready: ready2 });
  }
  async function weight(ticketUuid, weightPoints) {
    return await window.axios.patch(T("ticket-allocator.tickets.weight", ticketUuid), {
      weight_points: weightPoints
    });
  }
  async function handler(ticketUuid, operatorUuid) {
    return await window.axios.patch(T("ticket-allocator.tickets.handler", ticketUuid), {
      operator_uuid: operatorUuid ?? null
    });
  }
  async function close(ticketUuid) {
    return await window.axios.delete(T("ticket-allocator.tickets.close", ticketUuid));
  }
...
//# sourceMappingURL=Dashboard-BXFPhalI.js.map

                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          ...
                                          _push7(ssrRenderComponent(VBtn, {
                                            ...
                                            to: _ctx.route("ticket-allocator.factors.create", { type: factorType.value }),
              ...
              [`item.active`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(unref(Link), {
                    as: "span",
                    href: _ctx.route("ticket-allocator.factors.update", item.uuid),
                    method: "patch",
              ...
              [`item.actions`]: withCtx(({ item }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(VBtn, {
                    to: _ctx.route("ticket-allocator.factors.edit", item.uuid),
                    icon: "mdi-pencil",
                    title: _ctx.$t("edit"),
                    size: "small",
                    variant: "plain"
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: _ctx.route("ticket-allocator.factors.raise-priority", item.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: _ctx.route("ticket-allocator.factors.lower-priority", item.uuid),
                    method: "put",
                  ...
                  _push3(ssrRenderComponent(_component_v_btn_ex, {
                    to: _ctx.route("ticket-allocator.factors.destroy", item.uuid),
                    method: "delete",
                    icon: "mdi-delete",
                    title: _ctx.$t("remove"),
                    size: "small",
...
//# sourceMappingURL=Index-c8920c80.js.map

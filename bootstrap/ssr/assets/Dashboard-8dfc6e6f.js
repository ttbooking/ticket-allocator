...
import { useEventListener, isClient, createSharedComposable, useLocalStorage, useTimestamp, usePointerLock, useMouse, computedAsync, until } from "@vueuse/core";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-dd23151d${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-dd23151d${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-dd23151d${_scopeId2}>`);
                  ...
                  ssrRenderList(unref(sortedOperators), (operator) => {
                    _push3(ssrRenderComponent(OperatorRow, {
                      key: operator.uuid,
                      operator,
                      onTransitionstart: ($event) => isRef(transitioning) ? transitioning.value = true : transitioning = true,
                      onTransitionend: ($event) => isRef(transitioning) ? transitioning.value = false : transitioning = false
                        ...
                        default: withCtx(() => [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(sortedOperators), (operator) => {
                            return openBlock(), createBlock(OperatorRow, {
                              ...
                              onTransitionstart: ($event) => isRef(transitioning) ? transitioning.value = true : transitioning = true,
                              onTransitionend: ($event) => isRef(transitioning) ? transitioning.value = false : transitioning = false
                            }, null, 8, ["operator", "onTransitionstart", "onTransitionend"]);
                          }), 128))
                        ]),
                        _: 1
                      })
...
const Dashboard_vue_vue_type_style_index_0_scoped_dd23151d_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-dd23151d"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-8dfc6e6f.js.map

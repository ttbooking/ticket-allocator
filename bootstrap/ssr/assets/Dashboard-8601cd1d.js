...
var _a, _b;
import { ref, computed, shallowRef, watch, provide, createVNode, withDirectives, resolveDirective, inject, vShow, nextTick, mergeProps, toRef, onBeforeMount, onBeforeUnmount, reactive, defineComponent, withCtx, createTextVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext, onMounted, withModifiers, resolveDynamicComponent, renderSlot, isRef, onUnmounted } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderVNode, ssrRenderSlot } from "vue/server-renderer";
import { I, _ as _sfc_main$5 } from "./Default-c6ea5c65.js";
import { T as TransitionGroup } from "./TransitionGroup-34a587b3.js";
import { useEventListener, isClient, createSharedComposable, useLocalStorage, useTimestamp, usePointerLock, useMouse } from "@vueuse/core";
import { trans } from "laravel-vue-i18n";
import dayjs from "dayjs";
import MarkdownIt from "markdown-it";
import MarkdownItAttrs from "markdown-it-attrs";
import { usePage, router, Head } from "@inertiajs/vue3";
import { k as keys, p as propsFactory, m as makeComponentProps, a as makeTagProps, b as makeThemeProps, g as genericComponent, c as provideTheme, u as useRtl, d as useLocale, e as useGroup, V as VBtn, f as useRender, h as makeGroupItemProps, i as makeLazyProps, j as useGroupItem, l as useSsrBoot, n as useLazy, M as MaybeTransition, o as convertToUnit, I as IconValue, q as makeGroupProps, r as useDisplay, s as useResizeObserver, t as IN_BROWSER, v as VFadeTransition, w as VIcon, x as focusableChildren, y as clamp, z as makeVInputProps, A as makeVSelectionControlProps, B as useProxiedModel, C as useLoader, D as useFocus, E as getUid, F as filterInputAttrs, G as VInput, H as VSelectionControl, L as LoaderSlot, J as VProgressCircular, K as omit, N as makeVBtnProps, O as useTextColor, P as animate, Q as standardEasing, R as makeDensityProps, S as useDensity, T as useBackgroundColor, U as provideDefaults, W as VOverlay, X as VBtnToggle, Y as VBtnGroup, Z as VTable } from "../ssr.js";
import { V as VCard, a as VCardText } from "./VCard-ad9951df.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { Repository as Repository$1, Query as Query$1, Model, useRepo } from "pinia-orm";
import { Uid, Attr, Str, Bool, Num, BelongsToMany, HasMany, OnDelete, Cast, BelongsTo } from "pinia-orm/decorators";
import { DateCast } from "pinia-orm/casts";
import { useCollect } from "pinia-orm/dist/helpers.js";
import { V as VContainer } from "./VContainer-aee7263c.js";
import { V as VRow, a as VCol } from "./VRow-aa85a200.js";
import { V as VAutocomplete } from "./VAutocomplete-04505b28.js";
import "@vue/shared";
...
function usePusherChannel(channel) {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const factors = computed(() => usePage().props.factors);
    const tab = ref(null);
    ...
    const reservedUntilInfo = computed(
      () => reservedUntil.value ? `${reservedUntil.value.format("lll")} (${trans("time_left", { time: reservedUntil.value.fromNow(true) })})` : null
    );
    ...
    const compact = (value) => value < 1e5 ? value : value.toExponential(1);
    const categoryName = () => {
      var _a2, _b2;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--45f9dbf5": animation.value.delay,
        "--eff8843c": animation.value.duration
      } };
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "d-inline-block" }, _attrs, _cssVars))} data-v-7998d353>`);
      _push(ssrRenderComponent(VBtn, {
        size: "small",
        class: ["ticket justify-start px-2", { overflow: overflow.value }],
        ripple: false,
        flat: "",
        width: "100"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a2, _b2, _c, _d;
          if (_push2) {
            if ((_a2 = _ctx.ticket.meta) == null ? void 0 : _a2.icon) {
              _push2(ssrRenderComponent(VIcon, {
                icon: ((_b2 = _ctx.ticket.meta) == null ? void 0 : _b2.icon) ?? "",
                color: "white"
              }, null, _parent2, _scopeId));
            } else {
              _push2(`<!---->`);
            }
            _push2(`<span class="text-white overflow-hidden" data-v-7998d353${_scopeId}><span class="title inline-block relative" data-v-7998d353${_scopeId}>${ssrInterpolate(title())}</span></span>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCard, {
                    width: "500",
                    "prepend-icon": ((_a3 = _ctx.ticket.meta) == null ? void 0 : _a3.icon) ?? "",
                        ...
                        _push4(ssrRenderComponent(VTabs, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(ssrRenderComponent(VTab, { value: "details" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                              ...
                              return [
                                ...
                                createVNode(VTab, { value: "details" }, {
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(_ctx.$t("details")), 1)
                                  ]),
                                  _: 1
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          if (typeof cardContent.value === "string") {
                                            _push7(`<div data-v-7998d353${_scopeId6}>${unref(md).render(cardContent.value)}</div>`);
                                          } else {
                                            _push7(`<table data-v-7998d353${_scopeId6}><tbody data-v-7998d353${_scopeId6}><!--[-->`);
                                            ssrRenderList(cardContent.value, ([key, value]) => {
                                              _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(key)}</th><td data-v-7998d353${_scopeId6}>${unref(md).renderInline(value)}</td></tr>`);
                                            });
                                            _push7(`<!--]--></tbody></table>`);
                                          }
                                        } else {
                                          return [
                                            typeof cardContent.value === "string" ? (openBlock(), createBlock("div", {
                                              key: 0,
                                              innerHTML: unref(md).render(cardContent.value)
                                            }, null, 8, ["innerHTML"])) : (openBlock(), createBlock("table", { key: 1 }, [
                                              createVNode("tbody", null, [
                                                (openBlock(true), createBlock(Fragment, null, renderList(cardContent.value, ([key, value]) => {
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table data-v-7998d353${_scopeId6}><tbody data-v-7998d353${_scopeId6}><tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("issued_on"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(createdAtInfo.value)}</td></tr>`);
                                          if (delayedUntil.value.isAfter(_ctx.$dayjs())) {
                                            _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("delayed_until"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(delayedUntilInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (boundAt.value) {
                                            _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("bound_at"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(boundAtInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (reservedUntil.value && reservedUntil.value.isAfter(_ctx.$dayjs())) {
                                            _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("reserved_until"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(reservedUntilInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          if (acceptedAt.value) {
                                            _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("accepted_at"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(acceptedAtInfo.value)}</td></tr>`);
                                          } else {
                                            _push7(`<!---->`);
                                          }
                                          _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("current_weight"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(currentWeightInfo.value)}</td></tr><tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("complexity"))}</th><td data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity + " " + unref(trans)("units"))}</td></tr></tbody></table>`);
                                        } else {
                                          return [
                                            createVNode("table", null, [
                                              createVNode("tbody", null, [
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("issued_on")), 1),
                                                  createVNode("td", null, toDisplayString(createdAtInfo.value), 1)
                                                ]),
                                                delayedUntil.value.isAfter(_ctx.$dayjs()) ? (openBlock(), createBlock("tr", { key: 0 }, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("delayed_until")), 1),
                                                  createVNode("td", null, toDisplayString(delayedUntilInfo.value), 1)
                                                ])) : createCommentVNode("", true),
                                                boundAt.value ? (openBlock(), createBlock("tr", { key: 1 }, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("bound_at")), 1),
                                                  createVNode("td", null, toDisplayString(boundAtInfo.value), 1)
                                                ])) : createCommentVNode("", true),
                                                reservedUntil.value && reservedUntil.value.isAfter(_ctx.$dayjs()) ? (openBlock(), createBlock("tr", { key: 2 }, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("reserved_until")), 1),
                                                  createVNode("td", null, toDisplayString(reservedUntilInfo.value), 1)
                                                ])) : createCommentVNode("", true),
                                                acceptedAt.value ? (openBlock(), createBlock("tr", { key: 3 }, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("accepted_at")), 1),
                                                  createVNode("td", null, toDisplayString(acceptedAtInfo.value), 1)
                                                ])) : createCommentVNode("", true),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("current_weight")), 1),
                                                  createVNode("td", null, toDisplayString(currentWeightInfo.value), 1)
                                                ]),
                                                createVNode("tr", null, [
                                                  createVNode("th", null, toDisplayString(_ctx.$t("complexity")), 1),
                                                  createVNode("td", null, toDisplayString(_ctx.ticket.complexity + " " + unref(trans)("units")), 1)
                                                ])
                                              ])
                                            ])
                                          ];
                                    ...
                                    _push6(ssrRenderComponent(VWindowItem, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<table class="table-fixed" data-v-7998d353${_scopeId6}><thead data-v-7998d353${_scopeId6}><tr data-v-7998d353${_scopeId6}><th class="w-1/3" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("factor"))}</th><th class="text-center" data-v-7998d353${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("initial_weight"))} data-v-7998d353${_scopeId6}>W<sub data-v-7998d353${_scopeId6}>0</sub></em></th><th class="text-center" data-v-7998d353${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("weight_increment"))} data-v-7998d353${_scopeId6}>W<sub data-v-7998d353${_scopeId6}>i</sub></em></th><th class="text-center" data-v-7998d353${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("complexity"))} data-v-7998d353${_scopeId6}>C</em></th><th class="text-center" data-v-7998d353${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("delay_sec"))} data-v-7998d353${_scopeId6}>D</em></th><th class="text-center" data-v-7998d353${_scopeId6}><em class="metric"${ssrRenderAttr("title", _ctx.$t("reservation_sec"))} data-v-7998d353${_scopeId6}>R</em></th></tr></thead><tbody data-v-7998d353${_scopeId6}><!--[-->`);
                                          ssrRenderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                            var _a4;
                                            _push7(`<tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown"))}</th><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(adjustments.initial_weight ?? 0)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(adjustments.weight_increment ?? 0)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(adjustments.complexity ?? 0)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(adjustments.delay ?? 0)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(adjustments.reservation ?? 0)}</td></tr>`);
                                          });
                                          _push7(`<!--]--></tbody><tfoot data-v-7998d353${_scopeId6}><tr data-v-7998d353${_scopeId6}><th data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.$t("total"))}</th><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.initial_weight)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.weight_increment)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.complexity)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.delay)}</td><td class="text-right" data-v-7998d353${_scopeId6}>${ssrInterpolate(_ctx.ticket.reservation)}</td></tr></tfoot></table>`);
                                        } else {
                                          return [
                                            createVNode("table", { class: "table-fixed" }, [
                                              createVNode("thead", null, [
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("th", { class: "text-center" }, [
                                                    createVNode("em", {
                                                      class: "metric",
                                                      title: _ctx.$t("delay_sec")
                                                    }, "D", 8, ["title"])
                                                  ]),
                                                  createVNode("th", { class: "text-center" }, [
                                                    createVNode("em", {
                                                      class: "metric",
                                                      title: _ctx.$t("reservation_sec")
                                                    }, "R", 8, ["title"])
                                                  ])
                                                ])
                                              ]),
                                              createVNode("tbody", null, [
                                                (openBlock(true), createBlock(Fragment, null, renderList(_ctx.ticket.metrics ?? {}, (adjustments, factorUuid) => {
                                                  var _a4;
                                                  return openBlock(), createBlock("tr", { key: factorUuid }, [
                                                    createVNode("th", null, toDisplayString(((_a4 = factors.value[factorUuid]) == null ? void 0 : _a4.name) ?? _ctx.$t("unknown")), 1),
                                                    ...
                                                    createVNode("td", { class: "text-right" }, toDisplayString(adjustments.reservation ?? 0), 1)
                                                  ]);
                                                }), 128))
                                              ]),
                                              createVNode("tfoot", null, [
                                                createVNode("tr", null, [
                                                  ...
                                                  createVNode("td", { class: "text-right" }, toDisplayString(_ctx.ticket.initial_weight), 1),
                                                  createVNode("td", { class: "text-right" }, toDisplayString(_ctx.ticket.weight_increment), 1),
                                                  createVNode("td", { class: "text-right" }, toDisplayString(_ctx.ticket.complexity), 1),
                                                  createVNode("td", { class: "text-right" }, toDisplayString(_ctx.ticket.delay), 1),
                                                  createVNode("td", { class: "text-right" }, toDisplayString(_ctx.ticket.reservation), 1)
                                                ])
                                              ])
                                            ])
                                          ];
                  ...
                  return [
                    createVNode(VCard, {
                      width: "500",
                      "prepend-icon": ((_b3 = _ctx.ticket.meta) == null ? void 0 : _b3.icon) ?? "",
                      title: cardTitle.value,
                      subtitle: cardSubtitle.value
                    }, {
                      default: withCtx(() => [
            ...
            return [
              ((_c = _ctx.ticket.meta) == null ? void 0 : _c.icon) ? (openBlock(), createBlock(VIcon, {
                key: 0,
                icon: ((_d = _ctx.ticket.meta) == null ? void 0 : _d.icon) ?? "",
                color: "white"
...
const Ticket_vue_vue_type_style_index_0_scoped_7998d353_lang = "";
...
const TicketComponent = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-7998d353"]]);
...
__decorateClass$3([
  Attr()
], OperatorTeam.prototype, "matching", 2);
__decorateClass$3([
  Attr()
...
let Ticket$1 = (_b = class extends Model {
  get duration() {
    return Math.round((useSharedTimestamp().value - this.created_at.getTime()) / 1e3);
  }
  get weight() {
...
__decorateClass([
  Num(0)
], Ticket$1.prototype, "reservation", 2);
__decorateClass([
  Cast(() => DateCast),
  Attr()
...
__decorateClass([
  Cast(() => DateCast),
  Attr(null)
], Ticket$1.prototype, "bound_at", 2);
__decorateClass([
  Cast(() => DateCast),
  Attr(null)
], Ticket$1.prototype, "accepted_at", 2);
__decorateClass([
  ...
  constructor() {
    ...
    __publicField(this, "create", (payload) => {
      this.save({
        ...
        bound_at: payload.operatorUuid ? (/* @__PURE__ */ new Date()).toISOString() : null
      });
    });
    ...
    __publicField(this, "accept", ({ uuid }) => {
      this.where("uuid", uuid).update({ accepted_at: (/* @__PURE__ */ new Date()).toISOString() });
    });
    ...
    __publicField(this, "adjustMetrics", ({ uuid, factorUuid, adjustments }) => {
      ...
      this.where("uuid", uuid).update({
        ...
        reservation: Math.max(0, (((_f = this.find(uuid)) == null ? void 0 : _f.reservation) ?? 0) + adjustments.reservation)
      });
    });
  }
  unbound() {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(unref(TransitionGroup), mergeProps({
        ...
        css: animationEnabled.value,
        onMouseup: unref(unlock)
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(_ctx.tickets, (ticket) => {
              _push2(ssrRenderComponent(TicketComponent, {
                key: ticket.uuid,
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(_ctx.tickets, (ticket) => {
                return openBlock(), createBlock(TicketComponent, {
                  key: ticket.uuid,
                  "data-uuid": ticket.uuid,
                  ticket,
                  draggable: "true",
                  class: "mr-1",
                  onMousedown: withModifiers(unref(lock), ["ctrl"])
                }, null, 8, ["data-uuid", "ticket", "onMousedown"]);
              }), 128))
            ];
          }
        }),
...
const TicketPool_vue_vue_type_style_index_0_scoped_ba6baa0a_lang = "";
...
const TicketPool = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-ba6baa0a"]]);
function useSupervisorApi() {
  async function ready(operatorUuid, ready2) {
    return await window.axios.patch(I("ticket-allocator.operators.ready", operatorUuid), { ready: ready2 });
  }
  async function weight(ticketUuid, weightPoints) {
    return await window.axios.patch(I("ticket-allocator.tickets.weight", ticketUuid), {
      weight_points: weightPoints
    });
  }
  async function handler(ticketUuid, operatorUuid) {
    return await window.axios.patch(I("ticket-allocator.tickets.handler", ticketUuid), {
      operator_uuid: operatorUuid ?? null
    });
  }
  async function close(ticketUuid) {
    return await window.axios.delete(I("ticket-allocator.tickets.close", ticketUuid));
  }
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-62b3ff4d>`);
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(cell.value), { class: "status py-1" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(cell.value), { class: "name !pt-[6px] font-weight-bold" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(cell.value), { class: "load !pt-[6px] text-center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "load", {}, () => {
              _push2(`${ssrInterpolate(_ctx.tickets.length)}`);
            ...
            return [
              renderSlot(_ctx.$slots, "load", {}, () => [
                createTextVNode(toDisplayString(_ctx.tickets.length), 1)
              ], true),
              createTextVNode("/"),
              renderSlot(_ctx.$slots, "load-max", {}, () => [
                createTextVNode("∞")
              ], true)
            ];
          }
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(cell.value), { class: "complexity !pt-[6px] text-center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "complexity", {}, () => {
              _push2(`${ssrInterpolate(complexity.value)}`);
            }, _push2, _parent2, _scopeId);
            _push2(`/`);
            ...
            return [
              renderSlot(_ctx.$slots, "complexity", {}, () => [
                createTextVNode(toDisplayString(complexity.value), 1)
              ], true),
              createTextVNode("/"),
              renderSlot(_ctx.$slots, "complexity-max", {}, () => [
                createTextVNode("∞")
              ], true)
            ];
          }
      ...
      _push(ssrRenderComponent(TicketPool, {
        tag: cell.value,
        tickets: _ctx.tickets,
        class: { collapsed: unref(collapsed) }
      }, null, _parent));
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(cell.value), { class: "more !pt-[2px] text-center" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
const TicketRow_vue_vue_type_style_index_0_scoped_62b3ff4d_lang = "";
...
const TicketRow = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-62b3ff4d"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(TicketRow, mergeProps({
        ...
        "data-uuid": _ctx.operator.uuid,
        class: ["operator", status.value]
      }, _attrs), {
        ...
        "load-max": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.operator.ticket_limit ?? "∞")}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.operator.ticket_limit ?? "∞"), 1)
            ];
          }
        }),
        "complexity-max": withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.operator.complexity_limit ?? "∞")}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.operator.complexity_limit ?? "∞"), 1)
            ];
          }
        }),
        name: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.operator.name)}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.operator.name), 1)
            ];
          }
        }),
        _: 1
...
var Common = /* @__PURE__ */ ((Common2) => {
  Common2["PropsInvalidated"] = ".props-invalidated";
  return Common2;
})(Common || {});
...
var Ticket = /* @__PURE__ */ ((Ticket2) => {
  ...
  Ticket2["Accepted"] = ".ticket.accepted";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const channel = usePusherChannel(Channel);
    const filters = reactive({});
    const metaFilter = (meta) => {
      return Object.entries(filters).reduce((passes, x) => {
        const [filter, entries] = x;
        const prop = meta == null ? void 0 : meta[filter];
        const pass = prop === void 0 || !entries.length || entries.includes(prop.toString());
        return passes && pass;
      }, true);
    };
    const sortedOperators = computed(
      () => useCollect(
        ...
        }).whereHas("tickets").orWhere((operator) => !options.hideEmpty && operator.online).get()
      ).sortBy([
        ["online", "desc"],
        ["ready", "desc"],
        ["free_slots", "desc"],
    ...
    onMounted(() => {
      channel.listen(Common.PropsInvalidated, () => router.reload()).listen(Operator.Enrolled, operatorRepo.value.enroll).listen(Operator.Resigned, operatorRepo.value.resign).listen(Operator.NameChanged, operatorRepo.value.changeName).listen(Operator.Online, operatorRepo.value.setOnline).listen(Operator.Offline, operatorRepo.value.setOffline).listen(Operator.Ready, operatorRepo.value.setReady).listen(Operator.NotReady, operatorRepo.value.setNotReady).listen(Operator.TicketLimitAdjusted, operatorRepo.value.adjustTicketLimit).listen(Operator.ComplexityLimitAdjusted, operatorRepo.value.adjustComplexityLimit).listen(Ticket.Created, ticketRepo.value.create).listen(Ticket.Closed, ticketRepo.value.close).listen(Ticket.Bound, ticketRepo.value.bind).listen(Ticket.Accepted, ticketRepo.value.accept).listen(Ticket.Unbound, ticketRepo.value.unbind).listen(Ticket.CategoryChanged, ticketRepo.value.changeCategory).listen(Ticket.MetaValueSet, ticketRepo.value.setMetaValue).listen(Ticket.MetaValuesMerged, ticketRepo.value.mergeMetaValues).listen(Ticket.MetricsAdjusted, ticketRepo.value.adjustMetrics);
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-afd65e2e${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-afd65e2e${_scopeId}>`);
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VAutocomplete, {
                                  modelValue: filters[matcher],
                                  "onUpdate:modelValue": ($event) => filters[matcher] = $event,
                                  multiple: "",
                                  clearable: "",
                                  chips: "",
                                  "closable-chips": "",
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<thead class="align-top" data-v-afd65e2e${_scopeId2}>`);
                  _push3(ssrRenderComponent(TicketRow, {
                    pool: "",
                  ...
                  _push3(ssrRenderComponent(unref(TransitionGroup), {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<!--[-->`);
                        ssrRenderList(sortedOperators.value, (operator) => {
                          _push4(ssrRenderComponent(OperatorRow, {
                            key: operator.uuid,
                            operator
                        ...
                        return [
                          (openBlock(true), createBlock(Fragment, null, renderList(sortedOperators.value, (operator) => {
                  ...
                  return [
                    createVNode("thead", { class: "align-top" }, [
...
const Dashboard_vue_vue_type_style_index_0_scoped_afd65e2e_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-afd65e2e"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-8601cd1d.js.map

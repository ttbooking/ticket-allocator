  ...
  setup(__props) {
    ...
    const metaFilter = (meta) => {
      return Object.entries(filters.value).reduce((passes, x) => {
        ...
        const pass = prop === void 0 || entries.length > 0 && entries.includes(prop.toString());
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$5, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight" data-v-292b7d31${_scopeId}>${ssrInterpolate(_ctx.$t("dashboard"))}</h2>`);
          } else {
            return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-292b7d31${_scopeId}>`);
            ...
            _push2(ssrRenderComponent(VTable, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<tbody class="align-text-top" data-v-292b7d31${_scopeId2}>`);
...
const Dashboard_vue_vue_type_style_index_0_scoped_292b7d31_lang = "";
...
const Dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-292b7d31"]]);
export {
  Dashboard as default
};
//# sourceMappingURL=Dashboard-c62ab2e0.js.map

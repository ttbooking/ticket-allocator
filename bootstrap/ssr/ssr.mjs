  ...
  watch(() => props.headers, () => {
    ...
    flat.forEach((_ref4) => {
      ...
      for (let i2 = row; i2 <= row + (column.rowspan ?? 1) - 1; i2++) {
        ...
        fixedOffsets[i2] += column.width ?? 0;
      }
    });
...
function sortItems(items, sortByItems, locale, customSorters) {
  ...
  return [...items].sort((a2, b2) => {
    for (let i2 = 0; i2 < sortByItems.length; i2++) {
      ...
      [sortA, sortB] = [sortA, sortB].map((s2) => (s2 || "").toString().toLocaleLowerCase());
      if (sortA !== sortB) {
    ...
    return () => {
      ...
      return isActive.value && withDirectives(createVNode(Tag, {
        ...
        default: () => {
          ...
          }, slots.prepend)]), ((_a = slots.default) == null ? void 0 : _a.call(slots, {
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name2) => resolvePageComponent(`./pages/${name2}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-6d7abc66.mjs"), "./pages/Factor/CreateEdit.vue": () => import("./assets/CreateEdit-93bfe129.mjs"), "./pages/Factor/Index.vue": () => import("./assets/Index-081d0a82.mjs"), "./pages/Operator/CreateEdit.vue": () => import("./assets/CreateEdit-6d4962dd.mjs"), "./pages/Operator/Index.vue": () => import("./assets/Index-06daf061.mjs"), "./pages/OperatorTeam/CreateEdit.vue": () => import("./assets/CreateEdit-5b29f779.mjs"), "./pages/OperatorTeam/Index.vue": () => import("./assets/Index-02f5abdf.mjs"), "./pages/TicketCategory/CreateEdit.vue": () => import("./assets/CreateEdit-88f415e7.mjs"), "./pages/TicketCategory/Index.vue": () => import("./assets/Index-41732f32.mjs") })),
    setup({ App, props, plugin }) {
      return createSSRApp({ name, render: () => h$1(App, props) }).use(plugin).use(pinia).use(vuetify).use(i18nVue, {
        resolve: (lang) => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../lang/en.json": () => import("./assets/en-f2804543.mjs"), "../../lang/php_en.json": () => import("./assets/php_en-d1fad207.mjs"), "../../lang/php_ru.json": () => import("./assets/php_ru-d102ba20.mjs"), "../../lang/ru.json": () => import("./assets/ru-a693f709.mjs") }), `../../lang/${lang}.json`)
      }).use(I, {
        // @ts-expect-error
        ...page.props.ziggy,
        // @ts-expect-error
...
export {
  ...
  makeSelectionControlProps as N,
  useLoader as O,
  useFocus as P,
  getUid as Q,

...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name2) => resolvePageComponent(`./pages/${name2}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-8ad2670c.mjs"), "./pages/Factor/CreateEdit.vue": () => import("./assets/CreateEdit-e570507c.mjs"), "./pages/Factor/Index.vue": () => import("./assets/Index-c6819781.mjs"), "./pages/Operator/CreateEdit.vue": () => import("./assets/CreateEdit-5100847a.mjs"), "./pages/Operator/Index.vue": () => import("./assets/Index-c2921079.mjs"), "./pages/OperatorTeam/CreateEdit.vue": () => import("./assets/CreateEdit-01623d6b.mjs"), "./pages/OperatorTeam/Index.vue": () => import("./assets/Index-e53b8b4c.mjs"), "./pages/TicketCategory/CreateEdit.vue": () => import("./assets/CreateEdit-63384b68.mjs"), "./pages/TicketCategory/Index.vue": () => import("./assets/Index-03c60ea9.mjs") })),
    setup({ App, props, plugin }) {
      return createSSRApp({ name, render: () => h$1(App, props) }).use(plugin).use(I, {
        // @ts-expect-error
        ...page.props.ziggy,
        // @ts-expect-error

...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name2) => resolvePageComponent(`./pages/${name2}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-ecdac523.mjs"), "./pages/Factor/CreateEdit.vue": () => import("./assets/CreateEdit-a4f118ea.mjs"), "./pages/Factor/Index.vue": () => import("./assets/Index-1371b933.mjs"), "./pages/Operator/CreateEdit.vue": () => import("./assets/CreateEdit-f7a527f7.mjs"), "./pages/Operator/Index.vue": () => import("./assets/Index-d12b6140.mjs"), "./pages/OperatorTeam/CreateEdit.vue": () => import("./assets/CreateEdit-ac5c83da.mjs"), "./pages/OperatorTeam/Index.vue": () => import("./assets/Index-a118f7fa.mjs"), "./pages/TicketCategory/CreateEdit.vue": () => import("./assets/CreateEdit-4c713585.mjs"), "./pages/TicketCategory/Index.vue": () => import("./assets/Index-7d000c55.mjs") })),
    setup({ App, props, plugin }) {
      return createSSRApp({ name, render: () => h$1(App, props) }).use(plugin).use(pinia).use(vuetify).use(i18nVue, {
        resolve: (lang) => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../lang/en.json": () => import("./assets/en-a72b77b2.mjs"), "../../lang/php_en.json": () => import("./assets/php_en-ba4202a0.mjs"), "../../lang/php_ru.json": () => import("./assets/php_ru-28f51547.mjs"), "../../lang/ru.json": () => import("./assets/ru-19d32fab.mjs") }), `../../lang/${lang}.json`)
      }).use($, {
        // @ts-expect-error
        ...page.props.ziggy,
        // @ts-expect-error

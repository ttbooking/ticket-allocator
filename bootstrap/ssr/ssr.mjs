...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name2) => resolvePageComponent(`./pages/${name2}.vue`, /* @__PURE__ */ Object.assign({ "./pages/Dashboard.vue": () => import("./assets/Dashboard-77eb837a.mjs"), "./pages/Factor/CreateEdit.vue": () => import("./assets/CreateEdit-231d57e9.mjs"), "./pages/Factor/Index.vue": () => import("./assets/Index-24517694.mjs"), "./pages/Factor/Partials/AssociationForm.vue": () => import("./assets/AssociationForm-2508df34.mjs"), "./pages/Factor/Partials/ExpressionForm.vue": () => import("./assets/ExpressionForm-dd4ac6c9.mjs"), "./pages/Operator/CreateEdit.vue": () => import("./assets/CreateEdit-e4d78693.mjs"), "./pages/Operator/Index.vue": () => import("./assets/Index-8cc2336e.mjs"), "./pages/OperatorTeam/CreateEdit.vue": () => import("./assets/CreateEdit-47dbbf26.mjs"), "./pages/OperatorTeam/Index.vue": () => import("./assets/Index-24ae215c.mjs"), "./pages/TicketCategory/CreateEdit.vue": () => import("./assets/CreateEdit-00d60ea8.mjs"), "./pages/TicketCategory/Index.vue": () => import("./assets/Index-a6b05f88.mjs") })),
    setup({ App, props, plugin }) {
      return createSSRApp({ name, render: () => h$1(App, props) }).use(plugin).use(pinia).use(vuetify).use(i18nVue, {
        resolve: (lang) => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../lang/en.json": () => import("./assets/en-00d993b4.mjs"), "../../lang/php_en.json": () => import("./assets/php_en-2f2cc441.mjs"), "../../lang/php_ru.json": () => import("./assets/php_ru-9c98643c.mjs"), "../../lang/ru.json": () => import("./assets/ru-0e6104f9.mjs") }), `../../lang/${lang}.json`)
      }).use($, {
        // @ts-expect-error
        ...page.props.ziggy,
        // @ts-expect-error
